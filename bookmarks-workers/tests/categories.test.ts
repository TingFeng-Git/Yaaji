...
describe('Category API', () => {
  ...
  describe('GET /api/categories', () => {
    ...
    it('should return all categories', async () => {
      db.seed('categories', [
        ...
        { id: 2, name: 'News', color: '#00ff00', created_at: '2024-01-02', user_id: 1 },
      ])
  ...
  describe('GET /api/categories/:id', () => {
    it('should return 404 for non-existent category', async () => {
      const res = await app.request('/api/categories/999', { headers: await authHeaders() }, env(db))
  ...
  describe('DELETE /api/categories/:id', () => {
    it('should return 404 for non-existent category', async () => {
      const res = await app.request('/api/categories/999', { method: 'DELETE', headers: await authHeaders() }, env(db))
      expect(res.status).toBe(404)
    })

    it('should delete an existing category without bookmarks', async () => {
      db.seed('categories', [
        { id: 1, name: 'ToDelete', color: '#000', created_at: '2024-01-01', user_id: 1 },
      ])

      const res = await app.request('/api/categories/1', { method: 'DELETE', headers: await authHeaders() }, env(db))
    ...
    it('should return 400 when category has bookmarks', async () => {
      db.seed('categories', [
        { id: 1, name: 'HasBookmarks', color: '#000', created_at: '2024-01-01', user_id: 1 },
      ])
      db.seed('bookmarks', [
        { id: 1, title: 'B', url: 'https://b.com', description: '', category_id: 1, click_count: 0, created_at: '2024-01-01', updated_at: '2024-01-01', last_clicked_at: null, user_id: 1 },
      ])
  ...
  describe('POST /api/categories/batch-delete', () => {
    ...
    it('should delete multiple categories without bookmarks', async () => {
      db.seed('categories', [
        { id: 1, name: 'A', color: '#000', created_at: '2024-01-01', user_id: 1 },
        { id: 2, name: 'B', color: '#000', created_at: '2024-01-02', user_id: 1 },
        { id: 3, name: 'C', color: '#000', created_at: '2024-01-03', user_id: 1 },
      ])
  ...
  describe('DELETE /api/categories/empty', () => {
    it('should delete categories with no bookmarks', async () => {
      db.seed('categories', [
        { id: 1, name: 'Empty', color: '#000', created_at: '2024-01-01', user_id: 1 },
        { id: 2, name: 'HasBookmarks', color: '#000', created_at: '2024-01-02', user_id: 1 },
      ])
      db.seed('bookmarks', [
        { id: 1, title: 'B', url: 'https://b.com', description: '', category_id: 2, click_count: 0, created_at: '2024-01-01', updated_at: '2024-01-01', last_clicked_at: null, user_id: 1 },
      ])

      const res = await app.request('/api/categories/empty', { method: 'DELETE', headers: await authHeaders() }, env(db))
      expect(res.status).toBe(200)
      const data = await res.json()
    ...
    it('should return 0 when no empty categories', async () => {
      db.seed('categories', [
        { id: 1, name: 'Full', color: '#000', created_at: '2024-01-01', user_id: 1 },
      ])
      db.seed('bookmarks', [
        { id: 1, title: 'B', url: 'https://b.com', description: '', category_id: 1, click_count: 0, created_at: '2024-01-01', updated_at: '2024-01-01', last_clicked_at: null, user_id: 1 },
      ])
